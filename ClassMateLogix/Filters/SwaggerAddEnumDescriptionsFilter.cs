...
namespace ClassMateLogix.Filters
{
    public class SwaggerAddEnumDescriptionsFilter : IDocumentFilter
    {
        ...
        private void DescribeEnumParameters(IDictionary<Microsoft.OpenApi.Models.OperationType, OpenApiOperation> operations, OpenApiDocument swaggerDoc)
        {
            if (operations != null)
            {
